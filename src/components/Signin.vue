        ...
        <div class="hero">
            <div class="form__box">
                ...
                <form id="login" class="input__group">
                    <h2>Login</h2>
                        <input v-model="username" type="text"  class="input__field" placeholder="Username" required>
                        <input v-model="password" type="text"  class="input__field" placeholder="Password" required>
