      ...
      questions: [
        {
          ...
          description:
            "I am having a hard time centering a div using flexbox and css, the following code i have used is not helpful, vertical-align : center",
          time: "4 days ago",
          user: "Jacob",
          tags: "php,html,css",
          id: 1,
...
<template>
  ...
  <div class="d-flex function-buttons-container">
    <a class="btn-ask-question" href="#/signin"> Ask a question </a>
    <a class="btn btn-outline-dark" href="#/signin"> Vote </a>
  </div>
